...
# Estilo para ajustar tamanho dos dados e deixar compacto
st.markdown("""
    <style>
    .card-box {
...
if file_upload and st.session_state.df_loggers is None:
    ...
    # Limpa espaços invisíveis de todas as células de texto
...
if st.session_state.df_loggers is not None:
    ...
    # Filtra itens Liberados e Disponíveis
    ...
    def render_categoria(cat_name):
        ...
        if sel:
            ...
            # Busca segura para evitar IndexError
